...
class ResidualBlock(nn.Module):
    def __init__(self, in_features):
        ...
        conv_block = [  nn.ReflectionPad2d(1),
                        nn.Conv2d(in_features, in_features, 3, padding = 1, dilation=1),
                        nn.InstanceNorm2d(in_features),
                        nn.ReLU(inplace=True),
                        nn.ReflectionPad2d(1),
                        nn.Conv2d(in_features, in_features, 3, padding = 2, dilation=2),
                        nn.InstanceNorm2d(in_features),
                        nn.ReLU(inplace=True),
                        nn.Conv2d(in_features, in_features, 3, padding = 3, dilation=5),
                        nn.InstanceNorm2d(in_features),
                        nn.ReLU(inplace=True)]
...
class Generator(nn.Module):
    def __init__(self, input_nc, output_nc):
        ...
        # Upsampling
        self.PSblock1 = nn.Sequential(nn.ConvTranspose2d(1024, 512, 3, stride=2, padding=1, output_padding=1),
                        nn.InstanceNorm2d(512),
                        nn.ReLU(inplace=True))
        self.PSblock2 = nn.Sequential(nn.ConvTranspose2d(512, 256, 3, stride=2, padding=1, output_padding=1),
                        nn.InstanceNorm2d(256),
                        nn.ReLU(inplace=True))
        self.PSblock3 = nn.Sequential(nn.ConvTranspose2d(256, 128, 3, stride=2, padding=1, output_padding=1),
                        nn.InstanceNorm2d(128),
                        nn.ReLU(inplace=True))
        self.PSblock4 = nn.Sequential(nn.ConvTranspose2d(128, 64, 3, stride=2, padding=1, output_padding=1),
                        nn.InstanceNorm2d(64),
                        nn.ReLU(inplace=True))
        ...
        self.conv_cat1 = nn.Sequential(
				nn.Conv2d(1024, 512, 1, 1, padding=0,bias=True),
				nn.InstanceNorm2d(512),
				nn.ReLU(inplace=True))
